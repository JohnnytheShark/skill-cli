  ...
  container.innerHTML = `
    <nav class="navbar" id="main-nav">
      <div class="nav-container">
        <a href="#" class="brand-logo" title="skill-cli Documentation Portal">
          <div class="logo-box">
        ...
        <div class="nav-links">
          ...
          <a href="#terminal-section">Terminal Demo</a>
          <a href="#downloads">Download</a>
        </div>

        <div class="nav-actions">
          <button class="search-trigger-btn" id="nav-search-btn" title="Search documentation (Ctrl+K)">
    ...
    <div class="mobile-drawer" id="mobile-nav-drawer">
      ...
      <a href="#terminal-section" class="mobile-nav-link">Terminal Simulator</a>
      <a href="#downloads" class="mobile-nav-link">Download Binary</a>
