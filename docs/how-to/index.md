...
> 
> These guides assume you already have `skill-cli` installed and running.
> Each guide focuses on a single, concrete task.
...
|---|---|
| [Sync a skills directory](./sync-skills-directory.md) | Bulk import `.md` skill files from a folder |
